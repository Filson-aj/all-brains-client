      ...
      {open && (
        <div className={`origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white 
          ...
          <div
            ...
            <div className='border-b border-gray-200 mb-2 p-2 font-bold text-sm'>
                <h2 className='hover:text-blue-600'>{user.email}</h2>
                <h2 className='hover:text-blue-600'>Status: {user.role}</h2>
            </div>
            <Link to='/profile'
